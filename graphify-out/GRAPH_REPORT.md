...
## Corpus Check
- 60 files · ~30,001 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 733 nodes · 1048 edges · 43 communities (31 shown, 12 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e404d49a`
...
Cohesion: 0.07
Nodes (45): ci95(), Student-t approximate 95% confidence-interval half-width for a mean., build_pairs(), load(), main(), paired_effects(), DataFrame, Path (+37 more)
...
Cohesion: 0.27
Nodes (10): Packet, string, UdpSocket, handleDroneStatus, handleTeamUpdate, handleVictimAck, scheduleTeamUpdateRelay, socketDataArrived (+2 more)
...
Cohesion: 0.08
Nodes (32): central_scalar(), collect(), DataFrame, ratio(), Read the small, normative ExperimentMetrics contract from one SCA file., Return a ratio without inventing a value when no alert was generated., Read exactly one scalar from the central collector. Missing or duplicate rows…, Return raw counters and auditable outcomes for one experimental run. (+24 more)
...
- **Why does `DroneApp` connect `DroneApp` to `optimize`, `DroneApp.cc`, `socketDataArrived`, `DroneApp.h`, `ExperimentMetrics.h`?**
